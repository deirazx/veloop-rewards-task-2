        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="sticky top-24 rounded-3xl bg-deep-card border border-slate-800 p-6 md:p-7 shadow-2xl space-y-6">
            ...
            <div className="space-y-3 pt-2">
              {isEnded ? (
                /* Concluded Giveaway State */
                <div className="p-5 rounded-2xl bg-rose-950/30 border border-rose-800/50 text-center space-y-2.5">
                  <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-rose-500/20 text-rose-400">
                    <Clock className="w-6 h-6" />
                  </div>
                  <h4 className="text-base font-bold text-white">Giveaway Has Concluded</h4>
                  <p className="text-xs text-slate-300 leading-relaxed">
                    The entry window for this draw has closed. Please check the Winners Hub to view verified audited winners.
                  </p>
                  <Link
                    to="/winners"
                    className="inline-flex items-center gap-1.5 px-4 py-2 mt-1 rounded-xl text-xs font-semibold text-rose-300 bg-rose-500/15 border border-rose-500/30 hover:bg-rose-500/25 transition"
                  >
                    View Official Winners Hub →
                  </Link>
                </div>
              ) : alreadyJoined ? (
